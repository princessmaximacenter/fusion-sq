...
#rsync -avhe ssh gerrit:/data/groups/gen/ivanbelzen/data/starfusion/wilms_v2/PMLBM000CVQ*RNA-Seq.star-fusion_predicted.tsv /hpc/pmc_gen/ivanbelzen/structuralvariation/tmp/.
