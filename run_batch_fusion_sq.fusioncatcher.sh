...
#cohort_run_file="${cohort_dir}/run_cohort.missing_all_fusioncatcher.tsv"
#batch="${wdir}rerun_full.lst"

#cohort_run_file="${cohort_dir}/run_cohort.missing_combine_fusioncatcher.tsv"
#batch="${wdir}rerun_combine.lst"
...
#runscript_prefix="run_fusion_sq."
#runscript_prefix="run_fusion_sq.manta."
runscript_prefix="run_fusion_sq.delly."
#runscript_prefix="run_fusion_sq.gridss."
...
while read -r patient_id tumor_id normal_id rna_id; do
    ...
    sbatch --mem=120Gb --time=50:00:00 ${runscript}
